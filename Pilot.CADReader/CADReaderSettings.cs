...
{
    class CADReaderSettings : INotifyPropertyChanged,  IObserver<KeyValuePair<string, string>>, IObserver<IDataObject>
    {
        ...
        public CADReaderSettings(IPersonalSettings personalSettings, IObjectsRepository repository)
        {
